            ...
            local Items = Cfg.Items; do 
                ...
                -- Page Directory
                    ...
                    Library:Create( "UIListLayout" , {
                        ...
                        Padding = dim(0, 6);
                        SortOrder = Enum.SortOrder.LayoutOrder;
                        -- VerticalFlex = Enum.UIFlexAlignment.Fill -- Removed to allow scrolling canvas to grow
                    });
                --
            end 
        ...
        function Library:Label(properties)
            ...
            local Items = Cfg.Items; do 
                ...
                Items.Name = Library:Create( "TextLabel" , {
                    ...
                    TextStrokeColor3 = rgb(255, 255, 255);
                    Text = Cfg.Name;
                    AutomaticSize = Enum.AutomaticSize.Y; -- MUST BE Y ONLY
                    Size = dim2(1, 0, 0, 0);
                    BorderSizePixel = 0;
                    TextWrapped = true;
                    TextXAlignment = Enum.TextXAlignment.Left;
        ...
        function Library:Notification(properties)
            ...
            local Items = Cfg.Items; do
                Items.Holder = Library:Create( "Frame" , {
                    ...
                    BorderColor3 = rgb(0, 0, 0);
                    AnchorPoint = vec2(1, 0);
                    AutomaticSize = Enum.AutomaticSize.Y; -- Growth follows text
                    Size = dim2(0, 260, 0, 21);
                    BorderSizePixel = 0;
                });	
